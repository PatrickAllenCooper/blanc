...
# DeFAb Phase B-SFT: Supervised Fine-Tuning
#
# Trains a LoRA adapter on DeFAb gold hypothesis data via SFT.
# The simplest post-training method: direct imitation of verified gold answers.
#
# Environment variables:
#   BASE_MODEL    HuggingFace model ID     (default: Qwen/Qwen2.5-72B-Instruct-AWQ)
#   CURRICULUM    joint | weighted | l12_only  (default: joint)
#   LORA_INIT     default | spectral       (default: default)
#   OUTPUT_DIR    Checkpoint dir           (auto-set from model + curriculum)
#
# Submit:
...
echo "======================================================================="
echo "DeFAb SFT Training (Phase B-SFT)"
echo "======================================================================="
...
OUTPUT_DIR="${OUTPUT_DIR:-experiments/finetuning/checkpoints/sft_${CURRICULUM}_${MODEL_SLUG}${INIT_SUFFIX}}"
...
echo ""
echo "======================================================================="
echo "SFT Training Complete (exit $EXIT_CODE)"
echo "End     : $(date)"
