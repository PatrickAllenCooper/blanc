...
\midrule
\multicolumn{2}{@{}l}{Materialized total (Tiers 0--3)} & 33,750,710 & 369,822+ \\
\bottomrule
\end{tabular}
\end{table}
...
\item \textbf{Instance count:} Tier~0: 409 (374 L2, 35 L3). Tier~1: 324,511 (182K L1, 142K L2) across five domains. Tier~2: 44,902 from FrameNet, UMLS, SUMO, Gene Ontology, Wikidata, and BabelNet. Synthetic: 409 contamination-control instances matched to Tier~0. Total: 369,822.
