...
%% M5 modality box — simple, no nested tikzpicture
\node[mbox, minimum height=0.42cm] at (3.50,-4.65) (m3) {M5 Visual};
...
\node[font=\fontsize{5.0}{6}\selectfont\itshape, text=defabGold!80,
      anchor=north] at (0,-5.15)
    {Five rendering modalities (M5: entity names replaced by images)};
