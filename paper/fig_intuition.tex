...
\begin{tikzpicture}[
    ...
    panel/.style={
        ...
        line width=0.4pt,
        text width=3.7cm, minimum height=2.6cm, anchor=north
    },
...
\node[panel] at (-5.7, 0) (pa) {%
  {\fontsize{7.5}{9}\selectfont\bfseries\color{defabBlue}(1) Default rule}\\[2pt]
...
\node[panel] at (0.0, 0) (pb) {%
  {\fontsize{7.5}{9}\selectfont\bfseries\color{defabRed}(2) Anomaly}\\[2pt]
...
\node[panel] at (5.7, 0) (pc) {%
  {\fontsize{7.5}{9}\selectfont\bfseries\color{defabTeal}(3) Constructed defeater}\\[2pt]
...
%% =================================================================
\node[verdict] at (0, -3.10) (v) {%
  Verifier resolves any such instance in under 50\,$\mu$s at 100\% accuracy. Best frontier LLM on L3 direct: \textbf{0.8--37\%}; rendering-robust: \textbf{7.8--23.5\%}. \textsc{DeFAb} makes this gap measurable, contamination-controlled, and trainable.%
};
