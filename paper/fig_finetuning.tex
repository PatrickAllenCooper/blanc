...
%
% Layout:
%   Properties strip   at (0,    2.4)   width 8cm height 0.6cm
%   Input box          at (-5.5, 0)     width 3.0cm height 1.2cm
%   Central verifier   at (0,    0)     width 4.0cm height 1.4cm
%   Four output boxes at (5.5, +1.8 / +0.6 / -0.6 / -1.8)  width 4.5cm height 0.95cm
%   Curriculum strip   at (0,   -2.4)   width 8cm height 0.6cm
%
\begin{tikzpicture}[
    >=stealth,
    verifier/.style={
