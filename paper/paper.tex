...
2 (extracted) & GO, MeSH, SUMO, FrameNet, Wikidata, UMLS, BabelNet & 535,565 & 47,482 \\
3 (extracted) & YAGO 4.5 full & 3,457,940 & --- \\
4 (counted) & YAGO facts (21.4\,GB, 312M triples) & 57,609,326$^{\dagger}$ & --- \\
\midrule
\multicolumn{2}{@{}l}{Materialized total (Tiers 0--3)} & 4,285,128 & 372,402 \\
\bottomrule
\end{tabular}
