...
%% =================================================================
\section{CoT Dissociation Figure}\label{app:cot_fig}
%% =================================================================

\begin{figure}[h]
\centering
\includegraphics[width=0.72\textwidth]{figures/fig_cot_dissociation.pdf}
\caption{Level~3 accuracy under direct prompting versus chain-of-thought for the four frontier models. Reasoning-optimized models (DeepSeek-R1, GPT-5.2) gain $+56$ to $+79$~pp under CoT; the instruction-optimized Claude~Sonnet~4.6 \emph{regresses} by $-14$~pp. Wilson 95\% CI half-widths $\pm 15$--$17$~pp at Level~3. Annotated values (\emph{Rob.}) show rendering-robust accuracy for each model; note that even the best CoT result (DeepSeek 92.9\%) corresponds to a rendering-robust score of only 23.5\%, confirming that CoT on formal modalities does not transfer to the headline metric.}
\label{fig:cot_dissociation}
\end{figure}
