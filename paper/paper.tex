...
Section~\ref{sec:method} formalizes the pipeline; Section~\ref{sec:experiments} presents the experimental design; Section~\ref{sec:finetuning} develops the preference optimization methodology for defeasible fine-tuning; Section~\ref{sec:debate} introduces the adversarial debate protocol; full definitions and proofs appear in the appendices.
