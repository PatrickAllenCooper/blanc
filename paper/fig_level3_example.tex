...
%% =================================================================
%% Inter-panel arrows -- use midway labels offset from the arrow line
%% so they do not collide with panel border text.
%% =================================================================
% (i) -> (ii)  horizontal between top panels
\draw[flow] ([yshift=-1.2cm]p1.north east) -- node[flowlbl, above=2pt] {\textbf{ablate} $r_4$} ([yshift=-1.2cm]p2.north west);

% (i) -> (iii)  vertical between left panels
\draw[flow] (p1.south) -- node[flowlbl, right=2pt] {\textbf{anomaly}} (p3.north);

% (ii) -> (iv)  vertical between right panels
\draw[flow] (p2.south) -- node[flowlbl, left=2pt] {\textbf{score}} (p4.north);

% (iii) -> (iv)  horizontal between bottom panels
\draw[flow] ([yshift=-1.2cm]p3.north east) -- node[flowlbl, above=2pt] {\textbf{construct}} ([yshift=-1.2cm]p4.north west);
